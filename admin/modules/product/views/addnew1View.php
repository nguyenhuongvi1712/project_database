...
if(isset($_POST['btn-submit'])){
    ...
    if(empty($data['error'])) {
        ...
        add_to_smartphone($_POST['product-code'],$_POST['screen'],$_POST['battery_capacity'],$_POST['rear_camera'],$_POST['front_camera'],$_POST['SIM'],$_POST['RAM'],$_POST['ROM'],$_POST['hdh'],$_POST['cpu'],$_POST['brand']);
